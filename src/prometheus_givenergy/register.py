...
class GivEnergyHoldingRegisterConversion(ModbusRegisterConversion):
    ...
    register_definition = {
        ...
        67: {'name': 'holding_ac_low_out_time'},
        68: {'name': 'holding_ac_high_out_time'},
        69: {'name': 'holding_ac_low_out_time'},
        70: {'name': 'holding_ac_high_out_time'},
        ...
        75: {'name': 'holding_ac_low_in_time'},
        76: {'name': 'holding_ac_high_in_time'},
        77: {'name': 'holding_ac_low_in_time'},
        78: {'name': 'holding_ac_high_in_time'},
